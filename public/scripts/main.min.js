...
},{"../is_date/index.js":2}],4:[function(require,module,exports){
...
},{"../parse/index.js":3}],5:[function(require,module,exports){
...
},{"check-types":1}],7:[function(require,module,exports){
'use strict';var renderer=require('lr-client-renderer'),road=require('lr-main')('client',{resetAfterCycle:!1}),websocketClient=require('../extensions/websocket/client')('http://watertables.lan/websocket/');road.extension('renderer',renderer,!0).extension('websocketClient',websocketClient,!0).middleware({'events.home':require('../middleware/events/home')}),require('./road')(road);

},{"../extensions/websocket/client":9,"../middleware/events/home":12,"./road":8,"lr-client-renderer":5,"lr-main":6}],8:[function(require,module,exports){
'use strict';module.exports=function(a){a.middleware({template:require('../middleware/template/default'),'store.fixture':require('../middleware/store/fixture')(),'store.single':require('../middleware/store/fixture')(1,!0),'store.empty':require('../middleware/store/empty'),'store.list':require('../middleware/store/list'),'component.home':require('../middleware/components/home'),'component.done':require('../middleware/components/done')}).where('webserver').run('*','template').run('/empty','store.empty').run('/empty','component.done').run('/single','body','POST').run('/single','store.single','POST').run('/fixture','store.fixture').run('/fixture','component.done').run('/','store.list').where('webserver','client').run('/','component.home').where('client').run('/','events.home','homeLoaded').run('data','events.home','websocket').where('webserver').done('response').done('response','POST')};

},{"../middleware/components/done":10,"../middleware/components/home":11,"../middleware/store/empty":13,"../middleware/store/fixture":14,"../middleware/store/list":15,"../middleware/template/default":16}],9:[function(require,module,exports){
'use strict';module.exports=function(){return function(b){var c=new WebSocket('ws://proto.royniels.nl/websockets/');c.addEventListener('message',function(d){var e=JSON.parse(d.data);b({matchValue:e.matchValue,updateType:e.updateType},e.body)})}};

},{}],10:[function(require,module,exports){
'use strict';module.exports=function(a,b){b.extensions.renderer.render('Done biatch','.content'),a()};
...
'use strict';var parse=require('date-fns/parse');module.exports=function(a,b,c){function e(g){var h='.graph';document.querySelector(h).innerHTML='';var i={top:40,right:20,bottom:30,left:40},j=960-i.left-i.right,k=500-i.top-i.bottom,l=d3.scaleBand().domain(g.map(function(r){return r.timestamp})).rangeRound([0,j]).paddingInner(0.1),m=d3.scaleLinear().domain([0,100]).range([k,0]),n=d3.axisBottom(l).tickFormat(d3.timeFormat('%M')),o=d3.axisLeft(m),p=d3.select(h).append('svg').attr('width',j+i.left+i.right).attr('height',k+i.top+i.bottom).append('g').attr('transform','translate('+i.left+','+i.top+')');p.append('g').attr('class','x axis').attr('transform','translate(0,'+k+')').call(n),p.append('g').attr('class','y axis').call(o);var q=p.selectAll('.bar').data(g);q.enter().append('rect').attr('class','bar').attr('x',function(r){return l(r.timestamp)}).attr('width',l.bandwidth()).attr('y',function(r){return m(r.level)}).attr('height',function(r){return k-m(r.level)})}var f;c?(c.timestamp=parse(c.timestamp),f=b.state,f.shift(),f.push(c),e(f)):(f=b.state?b.state:window.__state__.watertable,f.forEach(function(g){g.timestamp=parse(g.timestamp)}),e(f.reverse())),a({state:f})};

},{"date-fns/parse":3}],13:[function(require,module,exports){
'use strict';module.exports=function(a,b){var c=b.extensions.store.collection('watertable');c.deleteMany(function(d){if(d)throw new Error(d);a()})};

},{}],14:[function(require,module,exports){
'use strict';var setMinutes=require('date-fns/set_minutes');module.exports=function(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:30,b=1<arguments.length&&arguments[1]!==void 0&&arguments[1];return function(c,d){var e=d.extensions.store.collection('watertable'),f;f=b?[Object.assign({},d.body,{timestamp:new Date})]:Array(a).fill().map(function(g,h){return{id:1,level:Math.round(70*Math.random()+10),timestamp:setMinutes(new Date,h)}}),e.insertMany(f,function(g){if(g)throw new Error(g);c()})}};

},{"date-fns/set_minutes":4}],15:[function(require,module,exports){
'use strict';module.exports=function(a,b){var c=b.extensions.store.collection('watertable');c.find({},{limit:30,sort:'timestamp'}).toArray(function(d,e){if(d)throw new Error(d);b.extensions.renderer.state({watertable:e}),a()})};

},{}],16:[function(require,module,exports){
"use strict";module.exports=function(a,b){b.extensions.renderer.template("\n<!DOCTYPE html>\n\t<html>\n\t\t<head>\n\t\t\t<meta charset=\"utf-8\">\n\n\t\t\t<title>Water tables (prototype)</title>\n\n\t\t\t<script src=\"https://d3js.org/d3.v4.min.js\"></script>\n\t\t\t<script src=\"/scripts/main.min.js\"></script>\n\n\t\t\t<link rel=\"stylesheet\" href=\"/stylesheets/styles.css\">\n\n\t\t</head>\n\t\t<body>\n\t\t\t<section class=\"content\"></section>\n\t\t\t<script id=\"state\"></script>\n\t\t</body>\n\t</html>\n\t"),a()};

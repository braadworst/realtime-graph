...
'use strict';module.exports=function(){return function(b){var c=new WebSocket('ws://watertables.lan/websockets/');c.addEventListener('message',function(d){var e=JSON.parse(d.data);b({matchValue:e.matchValue,updateType:e.updateType},e.body)})}};
